原始数据格式为CSV文件，单个文件大小约为2GB，由于github上传文件具有容量限制，无法将csv文件上传至项目中。但是你可以通过Google Drive获取原始文件，地址为<a href="https://drive.google.com/drive/folders/1kd6z_HsaO_YHdOMjFVp59SORWlGwL3Jb?usp=sharing">下载地址</a>。
